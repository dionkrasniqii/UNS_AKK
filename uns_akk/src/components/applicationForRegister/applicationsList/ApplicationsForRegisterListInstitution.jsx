...
export default function ApplicationsForRegisterListInstitution() {
  ...
  const columns = [
    ...
    //       return (
    //         <Link
    //           to={`/edit-register-application/${row.id}`}
    ...
    try {
      ...
      if (decodedToken) {
        CrudProvider.getItemById(
          "ApplicationAPI/GetAllRegisterApplicationsForInstitution",
