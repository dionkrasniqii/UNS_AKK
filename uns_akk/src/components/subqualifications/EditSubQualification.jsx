...
async function GetAllQualificationsWithLang() {
    CrudProvider.getAllWithLang("GeneralAPI/GetAllQualifications").then((res) => {
        if (res) {
    ...
    useEffect(() => {
      setLoad(true);
      Promise.all([
        CrudProvider.getItemById("QualificationChildAPI/GetById", id).then((res) => {
          if (res) {
            if (res.statusCode === 200) {
              const obj = res.result;
              setSubQualification({
                  ...subqualification,
                  QualificationId:obj[0].qualificationChild.qualification.qualificationId,
                  CodeAL:obj[2].code,
                  CodeEN:obj[1].code,
                  CodeSR:obj[0].code,
    ...
    qualifications.length > 0 &&
    qualifications.find( 
        (obj) =>  obj.qualification.qualificationId === subqualification.QualificationId
      ); 
